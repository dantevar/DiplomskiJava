...
/**
 * CMA-ES Analysis Runner
 * 
 * Testira CMA-ES algoritam na više instanci iz dataseta.
 * Mjeri performanse: vrijeme izvođenja, prosječan gap, standardna devijacija.
 */
public class CMAESAnalysis {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("=== CMA-ES Algorithm Analysis ===");
        System.out.println("Graph size: n=" + n);
        System.out.println("Number of instances: " + numInstances);
        System.out.println();
        
        // Različiti brojevi generacija
        int[] generationCounts = {50, 100, 150};
        
        for (int generations : generationCounts) {
            System.out.println("─".repeat(60));
            System.out.printf("Testing CMA-ES with %d generations%n", generations);
            System.out.println("─".repeat(60));
            
            runAnalysis(n, numInstances, generations);
            System.out.println();
        }
    ...
    /**
     * Pokreni analizu za zadani broj generacija
     */
    private static void runAnalysis(int n, int numInstances, int generations) {
        ...
        for (int i = 0; i < numInstances; i++) {
            try {
                ...
                if (i == 0) {
                    ...
                    System.out.printf("  CMA-ES cost:    %.4f%n", result.cost);
